...
import siam.moemoetun.com.shwedailyenglish.ui.adapter.ViewPagerAdapter;
import siam.moemoetun.com.shwedailyenglish.ui.webview.OnlineLessons;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String[] pageTitle = {"Basic Grammar","Downloads","Basic Speaking", "Story","Vocabulary",
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnCompleteListener(this, new OnCompleteListener<Boolean>() {
            ...
            public void onComplete(@NonNull Task<Boolean> task) {
                if(task.isSuccessful()){
                    ...
                    if(Integer.parseInt(new_version_code) >getVersionCode())upDateApp("siam.moemoetun.com.shwedailyenglish",new_version_code);
                }
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id==R.id.online){
            Intent intent = new Intent(MainActivity.this, OnlineLessons.class);
            startActivity(intent);
        }
        else if(id ==R.id.go){
            startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://www.moemoetun.me/privacy-policy-2/")));
        }
    ...
    public int getVersionCode(){
        ...
        return packageInfo != null ? packageInfo.versionCode : 42;
    }
